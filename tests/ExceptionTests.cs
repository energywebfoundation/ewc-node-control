...
namespace tests
{
    public class ExceptionTests
    {
        ...
        {
            var ex = new StateCompareException("Test message");
        ...
        {
            var ex = new ContractException("Test message");
            Action exThrow = () => throw ex;
        ...
        {
            // test w/o inner
            var ex = new UpdateVerificationException("Test message");
            Action exThrow = () => throw ex;
            exThrow.Should().Throw<UpdateVerificationException>()
                .WithMessage("Test Message");
            
            // test with inner
            var exWithInner = new UpdateVerificationException("Test message",new Exception("this is inner"));
